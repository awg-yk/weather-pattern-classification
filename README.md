...
`--date`は2022年10月1日以降であれば気象庁JSMAPアーカイブから、それより古い日付
(2000年〜2022年9月ごろ)であれば国立国会図書館デジタルコレクション(NDL)から自動で取得する。
NDL側は00Z(日本時間9時)のみ存在するため、その期間は`--hour 0`を指定すること
(気象庁アーカイブ側は`0`か`12`どちらも有効)。
